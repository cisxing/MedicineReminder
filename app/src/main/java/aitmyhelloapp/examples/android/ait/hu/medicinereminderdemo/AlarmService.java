    ...
    public void onStart(Intent intent, int startId)
    {
        ...
        try {
            if (intent!= null) {
                ...
                Notification notification = new Notification(R.drawable.alarm2, "Time to take medicine!", System.currentTimeMillis());

                intent1.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);

                PendingIntent pendingNotificationIntent = PendingIntent.getActivity(this.getApplicationContext(), 0, intent1, PendingIntent.FLAG_UPDATE_CURRENT);
                notification.flags |= Notification.FLAG_AUTO_CANCEL;
                notification.setLatestEventInfo(this.getApplicationContext(), "Time to take medicine!!", "Click on the notification to set record", pendingNotificationIntent);
